...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
  ...
  const handleSubmit = async () => {
    if (!form.title || !form.description || form.affected_zones.length === 0) {
      toast.error("Fill all fields and select at least one zone.");
      return;
    }
    setLoading(true);
    try {
      ...
      >
        ...
        <div
          style={{
            ...
            background:
              "linear-gradient(180deg,rgba(244,63,94,0.06) 0%,transparent 100%)",
...
<<<<<<< HEAD
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="watch" className="text-xs">
                    🟡 Watch
                  </SelectItem>
                ...
                return (
                  <label
                    ...
                    style={{
                      ...
                      borderRadius: "9px",
                      cursor: "pointer",
                      border: `1px solid ${checked ? "rgba(244,63,94,0.35)" : "rgba(244,63,94,0.12)"}`,
                      background: checked
                        ? "rgba(244,63,94,0.08)"
                        : "transparent",
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
          ...
          <div style={{ display: "flex", gap: "12px" }}>
            {[
              { key: "broadcast_sms", label: "📱 SMS Broadcast" },
              { key: "broadcast_call", label: "📞 Voice Call" },
            ].map(({ key, label }) => {
...
<<<<<<< HEAD
                <label
                  ...
                  style={{
                    ...
                    padding: "8px 14px",
                    borderRadius: "10px",
                    border: `1px solid ${val ? "rgba(244,63,94,0.3)" : "rgba(244,63,94,0.12)"}`,
                    background: val ? "rgba(244,63,94,0.06)" : "transparent",
                    cursor: "pointer",
                    flex: 1,
                  }}
                >
                  ...
                  <span
                    style={{
                      fontSize: "12px",
                      fontWeight: 600,
                      color: val ? "#f43f5e" : "var(--color-muted-foreground)",
                    }}
                  >
                    {label}
                  </span>
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
          ...
          >
            {loading ? (
              ...
              <>
                <Siren style={{ width: 15, height: 15 }} />
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
        ...
        <div
          style={{
            ...
            marginBottom: actionLabel ? "12px" : 0,
          }}
        >
...
<<<<<<< HEAD
            ...
            >
              {a.acknowledged_count}/{a.recipients_count}
            </span>
            <span
              style={{
                fontSize: "10px",
        ...
        {a.recipients_count > 0 && (
          <div
            style={{
              ...
              marginBottom: actionLabel ? "10px" : 0,
              marginTop: "8px",
              overflow: "hidden",
            }}
          >
...
<<<<<<< HEAD
          <button
            ...
            style={{
              ...
              height: "36px",
              borderRadius: "9px",
              border: `1px solid ${actionColor ?? "rgba(52,211,153,0.3)"}`,
    ...
    >
      ...
      <div
        style={{
          ...
          borderBottom: "1px solid rgba(244,63,94,0.12)",
          background:
            "linear-gradient(180deg,rgba(244,63,94,0.05) 0%,transparent 100%)",
          flexShrink: 0,
        }}
      >
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <div>
            ...
            >
              Situation Awareness · Incident Tracking · Mass Communication
            </p>
          </div>
          {/* Live pill */}
          <div
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          >
            <RefreshCw
              style={{ width: 13, height: 13, color: "#f43f5e" }}
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
        {[
          ...
          },
          {
            icon: ShieldAlert,
            label: "Watch",
            value: stats?.watch_count ?? 0,
            color: "#fbbf24",
          },
          {
            icon: Users,
            label: "Citizens Reached",
            value: stats?.total_citizens_reached ?? 0,
            color: "#a78bfa",
          },
          {
            icon: Smartphone,
            label: "SMS Dispatched",
            value: stats?.total_sms_sent ?? 0,
            color: "#60a5fa",
          },
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              backgroundImage:
                "radial-gradient(circle at 2px 2px, rgba(244,63,94,0.12) 1px, transparent 0)",
...
<<<<<<< HEAD
            ...
            >
              <Shield
                style={{ width: 48, height: 48, color: "rgba(52,211,153,0.3)" }}
              />
              <p
                style={{
                  fontSize: "14px",
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
        ...
        <div
          style={{
            width: "360px",
            flexShrink: 0,
            borderLeft: "1px solid rgba(244,63,94,0.1)",
            display: "flex",
            flexDirection: "column",
          }}
        >
          <div
            style={{
              ...
              background:
                "linear-gradient(180deg,rgba(244,63,94,0.04) 0%,transparent 100%)",
              flexShrink: 0,
              display: "flex",
              alignItems: "center",
              justifyContent: "space-between",
              ...
              >
                {activeAlerts.map((a) => (
                  <AlertCard
                    ...
                    onAction={async () => {
                      await api.put(`/api/disaster/alerts/${a.id}/resolve`);
                      fetchData();
                    }}
                  />
                ))}
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <div>
            ...
            >
              {user?.zone || "Unassigned Zone"} · Officer Dashboard
            </p>
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
      ...
      >
        {[
          ...
          {
            label: "Watch",
            value: activeAlerts.filter((a) => a.severity === "watch").length,
            color: "#fbbf24",
            icon: Eye,
          },
...
<<<<<<< HEAD
          ...
          >
            <Shield
              style={{ width: 40, height: 40, color: "rgba(52,211,153,0.3)" }}
            />
          ...
          >
            {activeAlerts.map((a) => (
              <AlertCard
                ...
                onAction={async () => {
                  await api.post(`/api/disaster/alerts/${a.id}/acknowledge`);
                  fetchAlerts();
                }}
              />
            ))}
    ...
    >
      ...
      <div
        style={{
          ...
          alignItems: "center",
          justifyContent: "space-between",
          borderBottom: `1px solid ${hasCritical ? "rgba(244,63,94,0.2)" : "rgba(139,92,246,0.1)"}`,
...
<<<<<<< HEAD
        {hasCritical && (
          ...
          >
            ...
            />
            <span
              style={{ fontSize: "12px", color: "#f43f5e", fontWeight: 800 }}
            >
              ATTENTION REQUIRED
            </span>
          </div>
...
<<<<<<< HEAD
            ...
            >
              All conditions in your area are nominal. This page will
              automatically update if an alert is issued.
            </p>
          </div>
        ) : (
          <div
          ...
          >
            ...
            >
              <Siren
                style={{ width: 16, height: 16, color: "#f43f5e" }}
                className="animate-pulse"
              />
              <p
                style={{
