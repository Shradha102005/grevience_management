...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
  {
    ...
    native: "EN",
    greeting:
      "Hello! I'm your AI Helpline Assistant. I can help you with government services, certificates, schemes, and more. What can I help you with today?",
  ...
  },
  {
    ...
    native: "हिं",
    greeting:
      "नमस्ते! मैं आपका AI हेल्पलाइन सहायक हूँ। मैं सरकारी सेवाओं, प्रमाणपत्रों, योजनाओं और अन्य विषयों में आपकी मदद कर सकता हूँ। आज आप क्या जानना चाहते हैं?",
  ...
  },
  {
    ...
    native: "తె",
    greeting:
      "నమస్కారం! నేను మీ AI హెల్ప్‌లైన్ అసిస్టెంట్‌ని. ప్రభుత్వ సేవలు, సర్టిఫికెట్లు, పథకాలు మరియు ఇతర విషయాలలో నేను మీకు సహాయం చేయగలను. ఈరోజు మీకు ఏమి కావాలి?",
    placeholder: "మీ ప్రశ్న టైప్ చేయండి…",
    quickPrompts: [
      "జన్మ ధృవీకరణ పత్రం ఎలా పొందాలి?",
      "రేషన్ కార్డు నవీకరణ",
  ...
  },
  {
    ...
    native: "த",
    greeting:
      "வணக்கம்! நான் உங்கள் AI ஹெல்ப்லைன் உதவியாளர். அரசு சேவைகள், சான்றிதழ்கள், திட்டங்கள் மற்றும் பலவற்றில் உதவ முடியும். இன்று என்ன தேவை?",
  ...
  },
  {
    ...
    native: "ಕ",
    greeting:
      "ನಮಸ್ಕಾರ! ನಾನು ನಿಮ್ಮ AI ಹೆಲ್ಪ್‌ಲೈನ್ ಸಹಾಯಕ. ಸರ್ಕಾರಿ ಸೇವೆಗಳು, ಪ್ರಮಾಣ ಪತ್ರಗಳು ಮತ್ತು ಯೋಜನೆಗಳ ಬಗ್ಗೆ ಸಹಾಯ ಮಾಡಬಲ್ಲೆ. ಇಂದು ಏನು ಬೇಕು?",
    placeholder: "ನಿಮ್ಮ ಪ್ರಶ್ನೆ ಟೈಪ್ ಮಾಡಿ…",
    quickPrompts: [
      "ಜನನ ಪ್ರಮಾಣ ಪತ್ರ ಹೇಗೆ ಪಡೆಯಬೇಕು?",
      "ರೇಷನ್ ಕಾರ್ಡ್ ನವೀಕರಣ",
      "ಆಸ್ತಿ ತೆರಿಗೆ ಪಾವತಿ",
      "ಆಧಾರ್ ನವೀಕರಣ",
    ],
  },
  {
    ...
    native: "മ",
    greeting:
      "നമസ്കാരം! ഞാൻ നിങ്ങളുടെ AI ഹെൽപ്‌ലൈൻ അസിസ്റ്റന്റ് ആണ്. സർക്കാർ സേവനങ്ങൾ, സർട്ടിഫിക്കറ്റുകൾ, പദ്ധതികൾ എന്നിവയിൽ സഹായിക്കാൻ കഴിയും. ഇന്ന് എന്ത് സഹായം വേണം?",
  ...
  },
  {
    ...
    native: "म",
    greeting:
      "नमस्कार! मी तुमचा AI हेल्पलाइन सहाय्यक आहे. सरकारी सेवा, प्रमाणपत्रे, योजना यांबद्दल मदत करू शकतो. आज तुम्हाला काय हवे आहे?",
    placeholder: "तुमचा प्रश्न टाइप करा…",
    quickPrompts: [
      "जन्म दाखला कसा मिळवायचा?",
      "रेशन कार्ड नूतनीकरण",
      "मालमत्ता कर भरणा",
      "आधार अद्यतन प्रक्रिया",
    ],
  },
  {
    code: "bn",
    ...
    native: "বাং",
    greeting:
      "নমস্কার! আমি আপনার AI হেল্পলাইন সহকারী। সরকারি সেবা, সার্টিফিকেট, প্রকল্প ইত্যাদিতে সাহায্য করতে পারি। আজ কীভাবে সাহায্য করব?",
...
const PRIORITY_CONFIG: Record<
  string,
  { dot: string; gradient: string; label: string }
> = {
  Critical: {
    dot: "#f43f5e",
    gradient: "linear-gradient(135deg,#f43f5e22,#e1134222)",
    label: "Critical",
  },
  High: {
    dot: "#fb923c",
    gradient: "linear-gradient(135deg,#fb923c22,#ea580c22)",
    label: "High",
  },
  Normal: {
    dot: "#818cf8",
    gradient: "linear-gradient(135deg,#818cf822,#6366f122)",
    label: "Normal",
  },
  Low: {
    dot: "#94a3b8",
    gradient: "linear-gradient(135deg,#94a3b822,#64748b22)",
    label: "Low",
  },
};
...
const CHANNEL_CONFIG: Record<string, { icon: React.ReactNode; color: string }> =
  {
    ...
    App: {
      icon: <Smartphone style={{ width: 12, height: 12 }} />,
      color: "#818cf8",
    },
  };
...
const MACROS = [
  {
    label: "Request Aadhaar",
    emoji: "🪪",
    text: "Could you please share the last 4 digits of your Aadhaar for verification?",
  },
  {
    label: "Link to Portal",
    emoji: "🔗",
    text: "You can complete this at: https://civicos.gov.in/services",
  },
  {
    label: "Escalate to L2",
    emoji: "⬆️",
    text: "Escalating to Level 2 support. They will contact you within 2 hours.",
  },
  {
    label: "Close Ticket",
    emoji: "✅",
    text: "This issue has been resolved. Closing ticket. Have a great day!",
  },
  {
    label: "Need More Info",
    emoji: "📋",
    text: "To help you better, could you please provide more details about your issue?",
  },
  {
    label: "MeeSeva Link",
    emoji: "🏛️",
    text: "Please visit your nearest MeeSeva centre or portal.meeseva.telangana.gov.in to complete this process.",
  },
];
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
  const orbAnim =
    state === "listening"
      ...
      : state === "speaking"
        ? "orbHeartbeat 1.0s ease-in-out infinite"
        : state === "thinking"
      ...
      >
        ...
        <img
          ...
          style={{
            ...
            mixBlendMode: "screen",
            WebkitMaskImage:
              "radial-gradient(ellipse 90% 90% at 50% 50%, black 45%, rgba(0,0,0,0.6) 60%, transparent 76%)",
            maskImage:
              "radial-gradient(ellipse 90% 90% at 50% 50%, black 45%, rgba(0,0,0,0.6) 60%, transparent 76%)",
...
function BotBubble({
  ...
  const timeStr = new Date(msg.ts).toLocaleTimeString("en-IN", {
    hour: "2-digit",
    minute: "2-digit",
  });
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
  ...
  const submit = async () => {
    ...
    try {
      ...
      onCreated(full);
      onClose();
      toast.success(`${ticket_id} created`);
    } catch {
      toast.error("Failed");
    } finally {
      setLoading(false);
    ...
    <Dialog open={open} onOpenChange={onClose}>
      ...
      >
        <div
          style={{
            background:
              "linear-gradient(135deg, #0a1628 0%, #0f2240 40%, #1e1b4b 100%)",
            border: "1px solid rgba(56,189,248,0.25)",
            borderRadius: "16px",
          }}
        >
          <div
            style={{
              background:
                "linear-gradient(135deg,rgba(56,189,248,0.15),rgba(129,140,248,0.08))",
...
<<<<<<< HEAD
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  style={{ ...inputStyle }}
                >
                  {["Web", "Phone", "Email", "App"].map((c) => (
                    <option key={c} style={{ background: "#0a1628" }}>
                      {c}
                    </option>
                  ))}
=======
...
<<<<<<< HEAD
                      ...
                      background:
                        form.priority === p
                          ? "linear-gradient(135deg,rgba(56,189,248,0.25),rgba(129,140,248,0.15))"
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
            ...
            <button
              ...
              style={{
                ...
                justifyContent: "center",
                gap: "8px",
                boxShadow: loading ? "none" : "0 0 24px rgba(56,189,248,0.4)",
                transition: "all 0.2s",
              }}
            >
              {loading ? (
    ...
    <button
      ...
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLElement).style.boxShadow =
          `0 8px 28px rgba(0,0,0,0.1), 0 0 0 1.5px ${sc.border}`;
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
  ...
  const senderColor =
    user?.role === "admin"
      ...
      : user?.role === "citizen"
        ...
        : "#a78bfa";
  const senderBg =
    user?.role === "admin" ? "rgba(245,158,11,0.15)" : "rgba(139,92,246,0.15)";
  const senderBorder =
    user?.role === "admin" ? "rgba(245,158,11,0.25)" : "rgba(139,92,246,0.25)";

  useEffect(() => {
    setCurrentTicket(ticket);
    setSubmitAs(ticket.status);
  }, [ticket]);
  useEffect(() => {
  ...
  }, [currentTicket.messages?.length, sending]);
  ...
  const sendReply = async () => {
    ...
    try {
      await fetch(
        `${API_BASE}/live/helpline/ticket/${currentTicket.ticket_id}/reply`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
            sender: senderName,
            sender_type: isOfficer ? "agent" : "user",
            text: replyText,
          }),
        },
      );
      if (submitAs !== currentTicket.status) {
        await fetch(
          `${API_BASE}/live/helpline/ticket/${currentTicket.ticket_id}/status`,
          {
            method: "PATCH",
            headers: { "Content-Type": "application/json" },
      ...
      const tr = await fetch(
        `${API_BASE}/live/helpline/ticket/${currentTicket.ticket_id}`,
      );
...
<<<<<<< HEAD
              ...
              >
                ...
                >
                  {initials(currentTicket.requester_name)}
                </div>
                <span
                  style={{
                    fontSize: "12px",
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
          ...
          {(currentTicket.messages || []).map((m, i) => {
            const displayName =
              m.sender === "Agent" && m.sender_type === "agent"
                ? "Support Officer"
                : m.sender;
            const isMine =
...
<<<<<<< HEAD
            ...
            >
              ...
              >
                ...
                >
                  {(senderName || "A").slice(0, 1).toUpperCase()}
                </div>
                <div
                  style={{
                    padding: "10px 16px",
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: "50%",
                  background: senderColor,
                  boxShadow: `0 0 6px ${senderColor}80`,
                }}
              />
              <span
                style={{
      ...
      >
        <Icon
          style={{
            width: 16,
            height: 16,
            color: active ? color : "rgba(139,92,246,0.5)",
          }}
        />
      </div>
      <div>
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
  ...
  const switchLanguage = (idx: number) => {
    ...
    setMessages([
      { role: "assistant", content: newLang.greeting, ts: Date.now() },
    ]);
    setInput("");
    setOrbState("idle");
    ...
    async (
      ...
      try {
        ...
        return {
          ...
          detectedLang: detected || langCode,
        };
      } catch {
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
      ...
      try {
        ...
        setIsTyping(false);
        const suggested: string[] = Array.isArray(data.suggested_replies)
        ...
        setMessages((prev) => [
          ...prev,
          {
            role: "assistant",
            content:
              "Connection error. Please check the backend service and try again.",
            ts: Date.now(),
          },
        ]);
      }
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
  ...
  const startListeningLoop = useCallback(async () => {
    ...
    recorder.onstop = async () => {
      ...
      const { transcript, detectedLang: spoken } = await transcribeAudio(
        blob,
        lang.code,
      );
      if (transcript) {
      ...
      {[0.5, 0.8, 1.0, 0.7, 0.4, 0.9, 0.6].map((base, i) => {
        const height = isRecording
          ? Math.max(
              ...
              Math.min(
                24,
                (audioLevel / 100) * 24 * base * (0.7 + Math.random() * 0.6),
              ),
            )
          : 4;
        return (
    ...
    <>
      <div
        style={{
          ...
          height: "100%",
          background:
            "linear-gradient(180deg, #0f172a 0%, #111827 60%, #131c35 100%)",
          ...
          {[...Array(12)].map((_, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: "50%",
                background:
                  i % 3 === 0 ? "#38bdf8" : i % 3 === 1 ? "#818cf8" : "#34d399",
                    ...
                    >
                      ...
                      <span
                        style={{
                          fontSize: "12px",
                          color:
                            i === langIdx ? "#38bdf8" : "rgba(255,255,255,0.6)",
                          fontWeight: i === langIdx ? 700 : 400,
                        }}
                      >
                        {l.label}
                      </span>
...
<<<<<<< HEAD
              <div
                style={{
                  ...
                  height: "7px",
                  borderRadius: "50%",
                  background: isRecording ? "#22d3ee" : "#64748b",
                  boxShadow: isRecording ? "0 0 10px #22d3ee" : "none",
                  animation: isRecording
                    ? "dotPulse 0.6s ease-in-out infinite alternate"
                    : "none",
                }}
              />
              <span
                style={{ fontSize: "11px", color: "#22d3ee", fontWeight: 700 }}
              >
                {isRecording
                  ? "Listening — speak now"
                  : orbState === "thinking"
          ...
          >
            <div
              style={{
                ...
                animation:
                  orbState !== "idle"
                    ? "dotPulse 0.8s ease-in-out infinite alternate"
                    : "none",
              }}
            />
            <span
...
<<<<<<< HEAD
                ...
                borderRadius: "20px",
                background:
                  "linear-gradient(135deg, rgba(34,211,238,0.15), rgba(56,189,248,0.1))",
...
<<<<<<< HEAD
              ...
              >
                Ticket auto-created: {escalatedTicketId}
              </p>
              <p
                style={{
                  fontSize: "10px",
...
>>>>>>> 4b6b11d5b8430477f7a10a0fb94cf381a9b34171
        ...
        {messages.length > 2 && (
          <div
            style={{ padding: "6px 14px 0", position: "relative", zIndex: 2 }}
          >
            <button
              onClick={handleLogTicket}
              style={{
  ...
  const fetchTickets = useCallback(
    async (silent = false) => {
      ...
      try {
        ...
        setCounts(data.counts || { Open: 0, Pending: 0, Resolved: 0, All: 0 });
        if (activeTicket) {
          const tr = await fetch(
            `${API_BASE}/live/helpline/ticket/${activeTicket.ticket_id}`,
          );
