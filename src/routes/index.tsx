...
import { ArrowRight, Sparkles, Terminal, Activity, BrainCircuit, Shield, TriangleAlert, Sprout, Sun, Droplets, Wind, CloudRain } from "lucide-react";
...
function LightLanding3D() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans overflow-hidden text-slate-900 selection:bg-indigo-500/30" onMouseMove={handleMouseMove}>
      ...
      <section id="modules" className="relative py-32 bg-slate-50 z-20 overflow-hidden">
                  ...
                  <div className="bg-white rounded-[2rem] p-4 sm:p-6 shadow-2xl shadow-indigo-500/10 border border-slate-200 relative overflow-hidden group">
                    <div className="bg-[#0B0F19] rounded-2xl border border-slate-800/60 flex flex-col items-center justify-center min-h-[360px] relative z-10 overflow-hidden">
                      ...
                      <div className="relative z-10 flex flex-col items-center justify-center">
                        <div className={`absolute inset-0 ${i === 4 ? 'bg-blue-600/20' : i === 3 ? 'bg-purple-500/30' : i === 2 ? 'bg-cyan-500/30' : i === 1 ? 'bg-fuchsia-500/30' : 'bg-indigo-500/30'} blur-2xl rounded-full scale-150`} />
                        <div className="h-20 w-20 flex items-center justify-center relative">
                          <m.icon className={`h-14 w-14 ${(i === 3 || i === 4 || i === 5) ? 'hidden' : i === 2 ? 'text-cyan-400 drop-shadow-[0_0_15px_rgba(6,182,212,0.5)]' : i === 1 ? 'text-fuchsia-400 drop-shadow-[0_0_15px_rgba(217,70,239,0.5)]' : 'text-indigo-400 drop-shadow-[0_0_15px_rgba(129,140,248,0.5)]'}`} strokeWidth={1.5} />
                          {i === 3 && <div className="absolute inset-0 m-auto h-16 w-16 rounded-full bg-purple-500 shadow-[0_0_30px_rgba(168,85,247,0.6)]" />}
                        </div>
                        {i === 3 && <div className="absolute -bottom-6 text-[9px] font-bold text-purple-400 tracking-widest uppercase">Hub</div>}
                      </div>
                      ...
                      {i === 0 ? (
                        <>
                          ...
                          <div className="absolute top-12 left-6 bg-[#131826] border border-slate-700/60 rounded-lg p-3 text-left w-32 shadow-xl backdrop-blur-md">
                            <div className="text-[10px] font-bold text-yellow-500 tracking-wider mb-1">PM HOUSING</div>
                          ...
                          <div className="absolute top-8 right-8 bg-[#131826] border border-yellow-500/30 rounded-lg p-3 text-left shadow-[0_0_15px_rgba(234,179,8,0.1)] backdrop-blur-md z-20">
                            <div className="text-[10px] font-bold text-yellow-500 tracking-wider mb-1">SCHEMES</div>
                            <div className="text-[12px] font-black text-white">500+ Active</div>
                          </div>
                          ...
                          <div className="absolute top-20 right-14 bg-[#131826] border border-slate-700/60 rounded-lg p-3 text-left w-32 shadow-xl backdrop-blur-md z-10">
                            <div className="text-[10px] font-bold text-yellow-500 tracking-wider mb-1">PM KISAN</div>
                            <div className="text-[11px] font-semibold text-emerald-400 flex items-center gap-1.5">
                          ...
                          <div className="absolute bottom-16 left-8 bg-[#131826] border border-slate-700/60 rounded-lg p-3 text-left w-32 shadow-xl backdrop-blur-md">
                            <div className="text-[10px] font-bold text-yellow-500 tracking-wider mb-1">SKILL INDIA</div>
                            <div className="text-[11px] font-semibold text-emerald-400 flex items-center gap-1.5">
                          ...
                          <div className="absolute bottom-20 right-10 bg-[#131826] border border-slate-700/60 rounded-lg p-3 text-left w-32 shadow-xl backdrop-blur-md">
                            <div className="text-[10px] font-bold text-yellow-500 tracking-wider mb-1">AYUSHMAN</div>
                            <div className="text-[11px] font-semibold text-emerald-400 flex items-center gap-1.5">
                          ...
                          <div className="absolute bottom-6 right-6 bg-[#131826] border border-emerald-500/40 rounded-lg px-3 py-2 text-center shadow-[0_0_15px_rgba(16,185,129,0.15)]">
                            <div className="text-[9px] font-bold text-slate-400 tracking-wider mb-0.5">AI ENGINE</div>
                            <div className="text-[11px] font-black text-emerald-400">LIVE</div>
                          </div>
                          
                          {/* Connecting SVG Lines */}
                          <svg className="absolute inset-0 h-full w-full pointer-events-none z-0" aria-hidden="true">
                            <line x1="50%" y1="50%" x2="20%" y2="25%" stroke="rgba(234,179,8,0.2)" strokeWidth="1" strokeDasharray="4 4" />
                            <line x1="50%" y1="50%" x2="80%" y2="25%" stroke="rgba(234,179,8,0.2)" strokeWidth="1" strokeDasharray="4 4" />
                            <line x1="50%" y1="50%" x2="20%" y2="75%" stroke="rgba(234,179,8,0.2)" strokeWidth="1" strokeDasharray="4 4" />
                            <line x1="50%" y1="50%" x2="80%" y2="75%" stroke="rgba(234,179,8,0.2)" strokeWidth="1" strokeDasharray="4 4" />
                          </svg>
                        </>
                      ) : i === 1 ? (
                        <>
                          ...
                          <div className="absolute top-10 left-10 bg-[#131826] border border-fuchsia-500/40 rounded-lg p-3 text-left w-32 shadow-[0_0_15px_rgba(217,70,239,0.15)] backdrop-blur-md">
                            <div className="text-[9px] font-bold text-fuchsia-400 tracking-wider mb-1">VOTER REACH</div>
                            <div className="text-[12px] font-black text-white">2.4M Citizens</div>
                          </div>
                          ...
                          <div className="absolute top-10 right-10 bg-[#131826] border border-fuchsia-500/40 rounded-lg p-3 text-left w-32 shadow-[0_0_15px_rgba(217,70,239,0.15)] backdrop-blur-md">
                            <div className="text-[9px] font-bold text-fuchsia-400 tracking-wider mb-1">MANIFESTO AI</div>
                            <div className="text-[12px] font-black text-white">GENERATING</div>
                          </div>
                          ...
                          <div className="absolute bottom-8 right-1/4 translate-x-4 bg-[#131826] border border-fuchsia-500/40 rounded-lg p-2.5 text-left shadow-[0_0_15px_rgba(217,70,239,0.15)] backdrop-blur-md z-20">
                            <div className="text-[9px] font-bold text-fuchsia-400 tracking-wider mb-1">SENTIMENT</div>
                            <div className="text-[11px] font-black text-white">78% Positive ↑</div>
                          </div>
                        </>
                      ) : i === 2 ? (
                        <>
                          ...
                          <div className="absolute top-8 right-8 bg-[#131826] border border-cyan-500/40 rounded-lg p-2.5 text-left shadow-[0_0_15px_rgba(6,182,212,0.15)] backdrop-blur-md z-20">
                            <div className="text-[9px] font-bold text-cyan-400 tracking-wider mb-1 uppercase">Call Center</div>
                            <div className="text-[11px] font-black text-white flex items-center gap-1.5">
                              <span className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" /> 24/7 LIVE
                            </div>
                          </div>
                          ...
                          <svg className="absolute inset-0 h-full w-full pointer-events-none z-0" aria-hidden="true">
                            <line x1="50%" y1="50%" x2="20%" y2="30%" stroke="rgba(6,182,212,0.3)" strokeWidth="1" />
                            <line x1="50%" y1="50%" x2="80%" y2="30%" stroke="rgba(6,182,212,0.3)" strokeWidth="1" />
                            <line x1="50%" y1="50%" x2="20%" y2="70%" stroke="rgba(6,182,212,0.3)" strokeWidth="1" />
                            <line x1="50%" y1="50%" x2="80%" y2="70%" stroke="rgba(6,182,212,0.3)" strokeWidth="1" />
                          </svg>

                          {/* Audio Waveform */}
                          <div className="absolute bottom-24 left-1/2 -translate-x-1/2 flex items-center gap-1 z-10">
                            {[12, 24, 16, 32, 20, 12, 28, 16, 24, 12].map((h, idx) => (
                              <motion.div
                                key={idx}
                                initial={{ height: 8 }}
                                animate={{ height: h }}
                                transition={{ duration: 0.8, repeat: Infinity, repeatType: "reverse", delay: idx * 0.1 }}
                          ...
                          <div className="absolute bottom-8 right-8 bg-[#131826] border border-cyan-500/40 rounded-lg p-2.5 text-left shadow-[0_0_15px_rgba(6,182,212,0.15)] backdrop-blur-md z-20">
                            <div className="text-[9px] font-bold text-cyan-400 tracking-wider mb-1 uppercase">Queries</div>
                            <div className="text-[11px] font-black text-white">1,240 Resolved Today</div>
                          </div>
                        </>
                      ) : i === 3 ? (
                        <>
                          ...
                          <div className="absolute bottom-0 left-0 right-0 h-16 flex items-end opacity-60 pointer-events-none z-0">
                            {[2, 4, 3, 5, 2, 6, 3, 4, 2, 5, 3, 4, 2, 3, 5, 2, 4, 3, 2, 5].map((h, idx) => (
                              <div key={idx} className="flex-1 bg-cyan-900/40 border-t border-cyan-500/30" style={{ height: `${h * 8}px` }} />
                            ))}
                          </div>
                          ...
                          <div className="absolute top-[20%] left-[25%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1 z-10">
                            ...
                            <span className="text-[9px] font-bold text-cyan-400 tracking-wider">Traffic</span>
                          </div>
                          ...
                          <div className="absolute top-[25%] left-[75%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1 z-10">
                            ...
                            <span className="text-[9px] font-bold text-yellow-400 tracking-wider">Power</span>
                          </div>
                          ...
                          <div className="absolute top-[75%] left-[25%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1 z-10">
                            ...
                            <span className="text-[9px] font-bold text-blue-400 tracking-wider">Water</span>
                          </div>
                          ...
                          <div className="absolute top-[70%] left-[75%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1 z-10">
                            ...
                            <span className="text-[9px] font-bold text-emerald-400 tracking-wider">Transit</span>
                          </div>

                          {/* Connecting Dashed Lines */}
                          <svg className="absolute inset-0 h-full w-full pointer-events-none z-0" aria-hidden="true">
                            <line x1="50%" y1="50%" x2="25%" y2="20%" stroke="rgba(168,85,247,0.4)" strokeWidth="1.5" strokeDasharray="4 4" />
                            <line x1="50%" y1="50%" x2="75%" y2="25%" stroke="rgba(168,85,247,0.4)" strokeWidth="1.5" strokeDasharray="4 4" />
                            <line x1="50%" y1="50%" x2="25%" y2="75%" stroke="rgba(168,85,247,0.4)" strokeWidth="1.5" strokeDasharray="4 4" />
                            <line x1="50%" y1="50%" x2="75%" y2="70%" stroke="rgba(168,85,247,0.4)" strokeWidth="1.5" strokeDasharray="4 4" />
                          </svg>
                          ...
                          <div className="absolute top-6 left-6 bg-[#131826] border border-cyan-500/40 rounded-lg p-2.5 text-left shadow-[0_0_15px_rgba(6,182,212,0.15)] backdrop-blur-md z-20">
                            <div className="text-[8px] font-bold text-cyan-400 tracking-wider mb-0.5 uppercase">Traffic</div>
                            <div className="text-[11px] font-black text-white flex items-center gap-1.5">
                              Live <span className="text-cyan-400">+</span> 98% Flow
                            </div>
                          </div>
                          ...
                          <div className="absolute top-6 right-6 bg-[#131826] border border-yellow-500/40 rounded-lg p-2.5 text-left shadow-[0_0_15px_rgba(234,179,8,0.15)] backdrop-blur-md z-20">
                            <div className="text-[8px] font-bold text-yellow-400 tracking-wider mb-0.5 uppercase">Power Grid</div>
                            <div className="text-[11px] font-black text-white">99.9% Uptime</div>
                          </div>
                          ...
                          <div className="absolute bottom-28 right-1/4 translate-x-8 bg-[#131826] border border-purple-500/40 rounded-lg p-2.5 text-left shadow-[0_0_15px_rgba(168,85,247,0.15)] backdrop-blur-md z-20">
                            <div className="text-[8px] font-bold text-purple-400 tracking-wider mb-0.5 uppercase">Smart Hub</div>
                            <div className="text-[11px] font-black text-white">4 Sensors Active</div>
                          </div>
                        </>
                      ) : i === 4 ? (
                        <>
                          ...
                          <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10 overflow-hidden">
                            ...
                            <div className="absolute bottom-12 w-64 h-24 border border-blue-500/20 rounded-[100%] z-0" style={{ transform: "rotateX(75deg)" }} />
                            <div className="absolute bottom-12 w-48 h-16 border border-blue-500/30 rounded-[100%] z-0" style={{ transform: "rotateX(75deg)" }} />
                            <div className="absolute bottom-12 w-32 h-10 border border-blue-500/40 rounded-[100%] z-0" style={{ transform: "rotateX(75deg)" }} />
                            
                            {/* Laser / Line shooting down */}
                            <div className="absolute top-1/2 left-1/2 w-[1px] h-64 bg-gradient-to-b from-orange-500 to-transparent shadow-[0_0_15px_rgba(249,115,22,0.8)] z-0" style={{ transformOrigin: "top center", transform: "rotate(20deg) translate(-15px, 0)" }} />
                            ...
                            <div className="relative flex items-center justify-center z-10 mb-12">
                              <Shield className="w-48 h-48 text-blue-500/80 drop-shadow-[0_0_25px_rgba(59,130,246,0.6)]" strokeWidth={1} />
                              <Shield className="absolute w-40 h-40 text-blue-400/50" strokeWidth={0.5} />
                              
                              {/* Inner Orange Triangle Alert */}
                              <div className="absolute flex items-center justify-center -translate-y-2">
                                <TriangleAlert className="w-16 h-16 text-orange-500 drop-shadow-[0_0_20px_rgba(249,115,22,0.8)]" strokeWidth={2} />
                          ...
                          <div className="absolute bottom-20 left-1/2 -translate-x-1/2 bg-[#131826]/80 border border-orange-500/40 rounded-lg py-2 px-6 text-center shadow-[0_0_20px_rgba(249,115,22,0.15)] backdrop-blur-md z-20 flex flex-col items-center">
                            ...
                            <div className="text-[9px] font-bold text-orange-500 tracking-widest pl-3 uppercase">Emergency</div>
                            <div className="text-[10px] font-black text-orange-400 pl-3 uppercase">Active</div>
                          </div>
                          ...
                          <div className="absolute top-8 left-8 bg-[#131826]/80 border border-orange-500/40 rounded-lg p-2.5 text-left shadow-[0_0_15px_rgba(249,115,22,0.15)] backdrop-blur-md z-20">
                            <div className="text-[8px] font-bold text-orange-500 tracking-wider mb-0.5 uppercase">Alert Status</div>
                            <div className="text-[11px] font-black text-white uppercase">Hazard Detected</div>
                          </div>
                          ...
                          <div className="absolute top-8 right-8 bg-[#131826]/80 border border-blue-500/40 rounded-lg p-2.5 text-left shadow-[0_0_15px_rgba(59,130,246,0.15)] backdrop-blur-md z-20">
                            <div className="text-[8px] font-bold text-blue-400 tracking-wider mb-0.5 uppercase">Region</div>
                            <div className="text-[11px] font-black text-white uppercase">NE-4 Zone</div>
                          </div>
                          ...
                          <div className="absolute bottom-10 left-8 bg-[#131826]/80 border border-green-500/40 rounded-lg p-2.5 text-left shadow-[0_0_15px_rgba(34,197,94,0.15)] backdrop-blur-md z-20">
                            <div className="text-[8px] font-bold text-green-500 tracking-wider mb-0.5 uppercase">Response</div>
                            <div className="text-[11px] font-black text-white uppercase">Active</div>
                          </div>
                          ...
                          <div className="absolute bottom-10 right-8 bg-[#131826]/80 border border-purple-500/40 rounded-lg p-2.5 text-left shadow-[0_0_15px_rgba(168,85,247,0.15)] backdrop-blur-md z-20">
                            <div className="text-[8px] font-bold text-purple-400 tracking-wider mb-0.5 uppercase">Broadcast</div>
                            <div className="text-[11px] font-black text-white uppercase">SMS + Call</div>
                          </div>
                        </>
                      ) : i === 5 ? (
                        <>
                          ...
                          {[
                            ...
                            <motion.div
                              ...
                              transition={{ duration: 3 + Math.random() * 2, repeat: Infinity, delay: firefly.delay }}
                              className="absolute rounded-full bg-green-400 shadow-[0_0_10px_rgba(34,197,94,0.8)] z-10"
                              style={{ top: firefly.top, left: firefly.left, width: firefly.size, height: firefly.size }}
                            />
                          ))}
                          ...
                          <div className="absolute top-[28%] left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center z-10">
                            ...
                            <m.icon className="h-16 w-16 text-green-400 drop-shadow-[0_0_20px_rgba(34,197,94,0.8)] z-10" strokeWidth={1} />
                          ...
                          <div className="absolute top-8 left-8 bg-[#131826]/90 border border-cyan-500/40 rounded-lg p-3 text-left shadow-[0_0_15px_rgba(6,182,212,0.15)] backdrop-blur-md z-20">
                            <div className="text-[9px] font-bold text-cyan-400 tracking-wider mb-1 uppercase">Villages</div>
                            <div className="text-[12px] font-black text-white">6,48,000 Covered</div>
                          </div>
                          ...
                          <div className="absolute top-8 right-8 bg-[#131826]/90 border border-yellow-500/40 rounded-lg p-3 text-left shadow-[0_0_15px_rgba(234,179,8,0.15)] backdrop-blur-md z-20">
                            <div className="text-[9px] font-bold text-yellow-400 tracking-wider mb-1 uppercase">Subsidies</div>
                            <div className="text-[12px] font-black text-white">₹2.4K Cr Disbursed</div>
                          </div>
                          ...
                          <div className="absolute bottom-6 left-8 right-8 flex flex-col gap-2 z-20">
                            {[
                              ...
                              <div key={idx} className="flex items-center justify-between bg-[#131826]/60 border border-green-500/20 rounded px-4 py-2 backdrop-blur-sm">
                                <div className="flex items-center gap-2">
                                  <div className="w-1.5 h-1.5 rounded-full bg-cyan-400 shadow-[0_0_8px_rgba(6,182,212,0.8)]" />
                                  <span className="text-[10px] font-bold text-cyan-400">{program.name}</span>
                                </div>
                                <span className="text-[10px] font-bold text-green-400">{program.status}</span>
                              </div>
                            ))}
                          </div>
                        </>
                        ...
                        <>
                          ...
                          <div className="absolute top-6 left-6 bg-[#0D1218]/90 border border-[#b5f02c]/30 rounded-lg py-2 px-3 text-left shadow-lg backdrop-blur-md z-20">
                            <div className="text-[9px] font-bold text-[#b5f02c] tracking-wider mb-0.5 uppercase">AI Scan</div>
                            <div className="text-[13px] font-black text-white flex items-center gap-1.5">
                              <Sprout className="w-4 h-4 text-[#b5f02c]" /> Crop Healthy
                            </div>
                          </div>
                          ...
                          <div className="absolute top-6 right-6 bg-[#0D1218]/90 border border-[#b5f02c]/30 rounded-lg py-2 px-3 text-left shadow-lg backdrop-blur-md z-20 min-w-[120px]">
                            <div className="text-[9px] font-bold text-[#b5f02c] tracking-wider mb-0.5 uppercase">Soil Health</div>
                            <div className="text-[13px] font-black text-white">pH 6.8 — Optimal</div>
                          </div>
                          ...
                          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[55%] flex items-center justify-center z-10 w-56 h-56">
                            ...
                            <svg className="absolute w-48 h-48 text-[#b5f02c]/80 drop-shadow-[0_0_10px_rgba(181,240,44,0.3)]" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="0.8">
                            ...
                            <svg className="absolute w-full h-full pointer-events-none z-10" viewBox="0 0 100 100">
                              <path d="M40 35 C 50 25 60 45 45 40" fill="none" stroke="rgba(181,240,44,0.6)" strokeWidth="0.5" />
                              <path d="M55 50 C 40 60 55 70 40 55" fill="none" stroke="rgba(181,240,44,0.6)" strokeWidth="0.5" />
                              <path d="M30 45 Q 50 50 70 40" fill="none" stroke="rgba(181,240,44,0.4)" strokeWidth="0.5" />
                            </svg>
                          ...
                          <div className="absolute top-[41%] right-[125px] w-[50px] h-[1px] bg-red-500/40 z-0" style={{ transform: "rotate(-10deg)" }} />
                          ...
                          <div className="absolute top-[38%] right-6 bg-[#0D1218]/90 border border-red-500/40 rounded-sm py-1.5 px-3 text-left shadow-[0_0_15px_rgba(239,68,68,0.2)] backdrop-blur-md z-20 flex flex-col justify-center">
                            <div className="flex items-center gap-1.5">
                              ...
                              <div className="text-[8px] font-bold text-red-500 tracking-wider uppercase">Pest Alert</div>
                            </div>
                            <div className="text-[10px] font-bold text-slate-300 mt-0.5 ml-4">Node C2</div>
                          </div>

                          {/* Bottom 4 Weather/Soil Cards */}
                          <div className="absolute bottom-6 left-6 right-6 grid grid-cols-4 gap-3 z-20">
                            {[
                              { label: "Sunny", value: "34°C", icon: Sun, iconColor: "text-amber-500 fill-amber-500" },
                              { label: "Humidity", value: "62%", icon: Droplets, iconColor: "text-blue-400 fill-blue-400" },
                              { label: "Wind", value: "14 km/h", icon: Wind, iconColor: "text-cyan-400" },
                              { label: "Rain", value: "Low Risk", icon: CloudRain, iconColor: "text-indigo-400 fill-indigo-400/30" },
                            ].map((item, idx) => (
                              <div key={idx} className="bg-[#0D1218]/90 border border-slate-700/50 rounded-xl py-3 px-2 flex flex-col items-center justify-center gap-1.5 backdrop-blur-md shadow-lg">
                                <item.icon className={`w-5 h-5 ${item.iconColor}`} strokeWidth={1.5} />
                                <div className="text-center mt-1">
                                  <div className="text-[8px] font-black tracking-wider uppercase text-[#b5f02c] mb-0.5">{item.label}</div>
                        ...
                        <>
                          ...
                          <div className="absolute top-6 left-1/2 -translate-x-1/2 bg-[#13101A]/90 border border-orange-500/30 rounded py-1.5 px-3 text-left shadow-[0_0_15px_rgba(249,115,22,0.15)] backdrop-blur-md z-20 flex flex-col justify-center items-center">
                            <div className="text-[7px] font-bold text-orange-500 tracking-widest mb-0.5 uppercase">Complaint Engine</div>
                          ...
                          <div className="absolute inset-0 top-20 bottom-20 px-6 grid grid-cols-3 gap-3 z-10">
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              <div className="flex items-center gap-1.5 bg-[#13101A]/80 border border-orange-500/20 rounded py-1 px-2 mb-1">
                                ...
                                <span className="text-[8px] font-bold text-orange-500 uppercase tracking-widest">New</span>
                              </div>
                              {/* Card 1 */}
                              <div className="bg-[#13101A]/90 border border-slate-700/50 rounded py-2.5 px-2.5 shadow-sm text-left">
                                <div className="text-[9px] font-bold text-slate-200 leading-tight">Road Pothole — Sector 4</div>
                              </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-2 relative">
                              ...
                              <div className="flex items-center gap-1.5 bg-[#13101A]/80 border border-blue-500/30 rounded py-1 px-2 mb-1">
                                ...
                                <span className="text-[8px] font-bold text-blue-500 uppercase tracking-widest">Routing</span>
                              </div>
                              {/* Card 1 */}
                              <div className="bg-[#13101A]/90 border border-blue-500/20 rounded py-2.5 px-2.5 shadow-sm text-left">
                                <div className="text-[9px] font-bold text-slate-200 leading-tight mb-2">Streetlight Fault — MG Rd</div>
                              ...
                              {/* Card 2 */}
                              <div className="bg-[#13101A]/90 border border-blue-500/20 rounded py-2.5 px-2.5 shadow-sm text-left">
                                <div className="text-[9px] font-bold text-slate-200 leading-tight mb-2">Water Leakage — Block B</div>
                                <div className="w-full bg-slate-800 rounded-full h-1">
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              <div className="flex items-center gap-1.5 bg-[#13101A]/80 border border-green-500/20 rounded py-1 px-2 mb-1">
                                ...
                                <span className="text-[8px] font-bold text-green-500 uppercase tracking-widest">Resolved</span>
                              </div>
                              {/* Card 1 */}
                              <div className="bg-[#13101A]/90 border border-green-500/20 rounded py-2.5 px-2.5 shadow-sm text-left">
                                <div className="text-[9px] font-bold text-slate-200 leading-tight mb-1.5">Garbage Pickup — Ward 7</div>
                                <div className="text-[8px] font-bold text-green-500 flex items-center gap-1">✓ Closed</div>
                              </div>
                              {/* Card 2 */}
                              <div className="bg-[#13101A]/90 border border-green-500/20 rounded py-2.5 px-2.5 shadow-sm text-left">
                                <div className="text-[9px] font-bold text-slate-200 leading-tight mb-1.5">Park Maintenance</div>
                                <div className="text-[8px] font-bold text-green-500 flex items-center gap-1">✓ Closed</div>
                              </div>
                            </div>
                          ...
                          <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between z-20">
                            ...
                            <div className="bg-[#13101A]/90 border border-slate-700/50 rounded p-2 text-center shadow-lg min-w-[50px]">
                              <div className="text-[11px] font-black text-orange-500">124</div>
                              <div className="text-[8px] font-bold text-slate-400 uppercase tracking-wider">Open</div>
                            </div>

                            {/* Center Stat */}
                            <div className="bg-[#13101A]/90 border border-slate-700/50 rounded p-2 text-center shadow-lg min-w-[60px]">
                              <div className="text-[11px] font-black text-green-500">89%</div>
                              <div className="text-[8px] font-bold text-slate-400 uppercase tracking-wider">SLA Met</div>
                            </div>

                            {/* Right Stat */}
                            <div className="bg-[#13101A]/90 border border-slate-700/50 rounded p-2 text-center shadow-lg min-w-[60px]">
                              <div className="text-[11px] font-black text-blue-500">6.4m</div>
                              <div className="text-[8px] font-bold text-slate-400 uppercase tracking-wider">Avg Close</div>
                            </div>
                          </div>
                        </>
                      ) : i === 8 ? (
                        <>
                          ...
                          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[55%] flex items-center justify-center z-10 w-64 h-64">
                            ...
                            <div className="relative z-20 flex flex-col items-center bg-[#090514] rounded-full p-3">
                              <m.icon className="w-10 h-10 text-violet-400 drop-shadow-[0_0_15px_rgba(139,92,246,0.6)]" strokeWidth={1} />
                            </div>
                          </div>
                          ...
                          {[
                            ...
                            <div key={idx} className="absolute bg-[#1A102A]/80 border border-violet-500/30 rounded-full px-3 py-1 text-[8px] font-bold text-violet-300 shadow-[0_0_10px_rgba(139,92,246,0.2)] backdrop-blur-md z-20" style={{ top: l.top, left: l.left }}>
                              {l.lang}
                            </div>
                          ))}
                          ...
                          <div className="absolute bottom-[20%] left-1/2 -translate-x-1/2 flex items-center justify-center gap-1 z-20 w-full px-8">
                            {[12, 16, 24, 18, 32, 20, 14, 28].map((h, idx) => (
                              <motion.div key={`left-${idx}`} animate={{ height: [h * 0.6, h, h * 0.6] }} transition={{ duration: 1.5, repeat: Infinity, delay: idx * 0.1 }} className="w-1.5 rounded-full bg-violet-500 shadow-[0_0_10px_rgba(139,92,246,0.6)]" style={{ height: h }} />
                            ))}
                            <div className="px-2 text-[9px] font-bold text-violet-300 shadow-[0_0_10px_rgba(139,92,246,0.2)]">Tamil</div>
                            {[28, 14, 20, 32, 18, 24, 16, 12].map((h, idx) => (
                              <motion.div key={`right-${idx}`} animate={{ height: [h * 0.6, h, h * 0.6] }} transition={{ duration: 1.5, repeat: Infinity, delay: idx * 0.1 }} className="w-1.5 rounded-full bg-violet-500 shadow-[0_0_10px_rgba(139,92,246,0.6)]" style={{ height: h }} />
                            ))}
                          </div>
                          ...
                          <div className="absolute top-6 right-6 bg-[#1A102A]/90 border border-violet-500/40 rounded-lg py-2 px-3 text-left shadow-[0_0_15px_rgba(139,92,246,0.2)] backdrop-blur-md z-30 min-w-[130px]">
                            <div className="text-[8px] font-bold text-violet-400 tracking-wider mb-0.5 uppercase">Voice AI</div>
                          ...
                          <div className="absolute bottom-6 right-6 bg-[#1A102A]/90 border border-violet-500/40 rounded-lg py-2 px-3 text-left shadow-[0_0_15px_rgba(139,92,246,0.2)] backdrop-blur-md z-30 min-w-[130px]">
                            <div className="text-[8px] font-bold text-violet-400 tracking-wider mb-0.5 uppercase">Queries</div>
                            <div className="text-[10px] font-black text-white">98% Recognition Rate</div>
                          </div>
                        </>
                      ) : (
      ...
      <section id="civicpulse" className="relative py-40 overflow-hidden bg-slate-50">
