  ...
  const handleProcessQuery = useCallback(
    async (text: string) => {
      ...
      try {
        ...
        const reply =
          data.reply ||
          "I didn't receive a response from the service. Please try again.";
        ...
        if (
          ...
          lowerQuery.includes("welfare") ||
          lowerQuery.includes("apply")
        ) {
          intent = "Scheme Discovery & Eligibility";
          actions = [
            {
              label: "Search Schemes via AI",
              route: "/portal/scheme-ai",
              icon: Landmark,
              color: "#10b981",
            },
            {
          ...
          actions = [
            {
              label: "Check Grievances Dashboard",
              route: "/portal/grievances",
          ...
          actions = [
            {
              label: "View Municipal Services",
              route: "/portal/municipal",
              icon: Building2,
              color: "#3b82f6",
            },
            {
              label: "View Smart City Dashboard",
              route: "/portal/smart-city",
              icon: Building2,
              color: "#06b6d4",
            },
          ];
          ...
          lowerQuery.includes("panchayat") ||
          lowerQuery.includes("village") ||
          lowerQuery.includes("mgnrega")
        ) {
          intent = "Rural Welfare & Schemes";
          actions = [
            {
              label: "Go to Rural Portal",
              route: "/portal/rural",
              icon: Sprout,
              color: "#84cc16",
            },
          ...
          actions = [
            {
              label: "Get Crop Diagnosis",
              route: "/portal/agriculture",
              icon: Leaf,
              color: "#16a34a",
            },
          ];
          ...
          actions = [
            {
              label: "View Live Alerts",
              route: "/portal/disaster",
              icon: Siren,
              color: "#ef4444",
            },
          ];
          ...
          lowerQuery.includes("outreach") ||
          lowerQuery.includes("speech")
        ) {
          intent = "Public Campaigns & Election";
          actions = [
            {
              label: "Campaign & Outreach manager",
              route: "/portal/election",
              icon: Megaphone,
              color: "#a855f7",
            },
          ];
          ...
          lowerQuery.includes("helpline") ||
          lowerQuery.includes("support")
        ) {
          intent = "Citizen Support Helpline";
          actions = [
            {
              label: "Connect with Helpline Chat",
              route: "/portal/helpline",
              icon: PhoneCall,
              color: "#ec4899",
            },
          ];
          ...
          actions = [
            {
              label: "Explore Portal Dashboard",
              route: "/portal",
              icon: LayoutDashboard,
              color: "#6366f1",
            },
        ...
        const errorMsg =
          "I'm having trouble communicating with the backend. Please ensure the server is running.";
    ...
    >
      ...
      >
        <div
          style={{
            ...
            background:
              orbState === "listening"
                ? "radial-gradient(circle, rgba(239,68,68,0.25) 0%, rgba(255,255,255,0) 70%)"
                : orbState === "processing"
                  ? "radial-gradient(circle, rgba(168,85,247,0.25) 0%, rgba(255,255,255,0) 70%)"
                  : orbState === "speaking"
                    ? "radial-gradient(circle, rgba(59,130,246,0.25) 0%, rgba(255,255,255,0) 70%)"
                    : "radial-gradient(circle, rgba(139,92,246,0.15) 0%, rgba(255,255,255,0) 70%)",
            transition: "all 1s ease-in-out",
            animation:
              orbState !== "idle" ? "pulseGlow 3s infinite alternate" : "none",
          }}
        />
      </div>
      ...
      >
        ...
        {orbState !== "idle" && (
          <Badge
            variant="outline"
            className="bg-white text-slate-800 border-slate-200 shadow-sm animate-in fade-in"
            style={{
              padding: "4px 10px",
              fontSize: "10px",
              letterSpacing: "0.1em",
      ...
      >
        ...
        <div
          style={{
            marginBottom: results ? "40px" : "60px",
        ...
        >
          <VoiceOrb
            ...
            onClick={toggleVoice}
            size="lg"
            className="shadow-[0_10px_40px_rgba(139,92,246,0.2)] rounded-full cursor-pointer"
          />
        </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Terminal
                    style={{ width: 14, height: 14, color: "#3b82f6" }}
                  />
                  <span
                    style={{
                      fontSize: "12px",
                ...
                <button
                  onClick={() => {
                    setResults(null);
                    setTranscript("Hi. How can I help you today?");
                  }}
                  style={{
                    width: "24px",
                    height: "24px",
                ...
                >
                  {results.actions.map((a: any, i: number) => (
                    ...
                    >
                      ...
                      >
                        <a.icon
                          style={{ width: 14, height: 14, color: a.color }}
                        />
                      </div>
      ...
      <div
        style={{
          ...
          zIndex: 10,
          background:
            "linear-gradient(0deg, rgba(248,250,252,1) 30%, rgba(248,250,252,0) 100%)",
        }}
      >
          ...
          >
            {QUICK_ACTIONS.map((a, i) => (
              <button
                key={i}
                onClick={() => {
                  setTranscript(a.label);
                  handleProcessQuery(a.label);
                }}
                style={{
                  display: "flex",
                  alignItems: "center",
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              height: "36px",
              borderRadius: "18px",
              background: orbState === "listening" ? "#ef4444" : "#f1f5f9",
              border: "none",
              color: "white",
              display: "flex",
              alignItems: "center",
          ...
          >
            <Mic
              style={{
                width: 16,
                height: 16,
                color: orbState === "listening" ? "white" : "#64748b",
              }}
