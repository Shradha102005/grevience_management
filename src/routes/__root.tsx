    ...
    head: () => ({
      meta: [
        ...
        { title: "CIVICOS AI — AI-Powered Citizen Governance Platform" },
        {
          name: "description",
          content:
            "CIVICOS AI is a unified, AI-powered platform for citizen schemes, grievances, emergency response, municipal services, and governance automation.",
        },
        { name: "author", content: "CIVICOS AI" },
        {
          property: "og:title",
          content: "CIVICOS AI — AI-Powered Citizen Governance Platform",
        },
        {
          property: "og:description",
          content:
            "One unified platform for schemes, grievances, emergency response, municipal services, citizen engagement and governance automation.",
        },
