...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "CIVICOS AI is a unified, AI-powered platform for citizen schemes, grievances, emergency response, municipal services, and governance automation." },
