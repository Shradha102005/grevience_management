...
function Municipal() {
  ...
  const fetchIssues = useCallback(async () => {
    ...
    try {
      ...
      const { data } = await api.get<PublicComplaint[]>(
  ...
  const handleCreate = async () => {
    if (!newForm.title || !newForm.location || !newForm.description) {
    ...
    >
      ...
      >
        <div className="flex items-center gap-4">
          <div
            className="h-12 w-12 rounded-2xl flex items-center justify-center text-blue-600 shadow-xl shadow-blue-500/10"
            style={{
        ...
        <div className="flex items-center gap-3">
          <div className="relative shadow-sm rounded-xl">
            ...
            <Input
              className="h-10 pl-10 text-sm w-64 bg-white/70 border-white shadow-sm text-slate-800 focus:border-blue-300 focus:ring-4 focus:ring-blue-500/10 rounded-xl transition-all placeholder:text-slate-400"
          ...
          <Select value={statusFilter} onValueChange={setStatusFilter}>
            <SelectTrigger className="h-10 text-sm w-40 bg-white/70 border-white shadow-sm text-slate-700 rounded-xl font-medium">
          ...
          <Button
            variant="outline"
            size="icon"
            className="h-10 w-10 border-white bg-white/70 text-slate-600 hover:bg-white shadow-sm rounded-xl"
            onClick={fetchIssues}
          >
          ...
          <Dialog open={newIssueOpen} onOpenChange={setNewIssueOpen}>
            <DialogTrigger asChild>
              <Button className="h-10 bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-500/20 font-bold px-5 ml-2 rounded-xl transition-transform hover:scale-105">
            ...
            <DialogContent className="sm:max-w-[500px] bg-white/90 backdrop-blur-2xl border-white shadow-2xl rounded-2xl text-slate-800">
              ...
              <div className="space-y-4 pt-4">
                <div className="grid gap-2">
                  ...
                  <Input
                    className="h-11 bg-white/50 border-slate-200 rounded-xl"
                    value={newForm.title}
                    onChange={(e) =>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewForm((f) => ({ ...f, location: e.target.value }))
                      }
                    />
                  </div>
                </div>
                <div className="grid gap-2">
                  ...
                  <Textarea
                    className="h-28 bg-white/50 border-slate-200 rounded-xl resize-none"
                ...
                <div className="flex justify-end gap-3 pt-6">
                  <Button
                    variant="ghost"
                    className="h-11 rounded-xl text-slate-600 hover:bg-slate-100 font-bold"
                    onClick={() => setNewIssueOpen(false)}
                  >
                    Cancel
                  </Button>
                  <Button
                    className="h-11 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 shadow-lg shadow-blue-500/20"
...
<<<<<<< HEAD
                        ...
                        <span
                          className={`text-[10px] font-extrabold uppercase tracking-widest px-2.5 py-0.5 rounded-md border ${statusColors[c.status] || "bg-slate-100 text-slate-600 border-slate-200"}`}
                        >
                          {c.status}
                        </span>
            ...
            <div className="px-10 py-8 border-b border-white/50 bg-white/40 flex justify-between items-start">
              <div className="flex items-start gap-6">
                <Button
                  ...
                  className="h-12 w-12 bg-white hover:bg-slate-50 border border-slate-100 text-slate-600 rounded-full shadow-sm shrink-0 transition-transform hover:scale-105"
                >
...
<<<<<<< HEAD
                      ...
                      <span className="text-xl font-bold flex items-center gap-3">
                        {priorityIcon[activeItem.priority]}{" "}
                        {activeItem.priority}
                      </span>
                    </div>
                    <div className="relative z-10">
                  ...
                  <div className="bg-white rounded-3xl p-8 border border-white shadow-xl shadow-slate-200/40">
                    ...
                    <div className="space-y-8 border-l-2 border-slate-100 ml-4 pl-8 relative">
                      <div className="relative">
                        <div className="absolute -left-[45px] top-0 h-8 w-8 rounded-full bg-slate-50 border-4 border-white flex items-center justify-center shadow-md">
                          <AlertCircle className="h-4 w-4 text-slate-500" />
                        </div>
                        <p className="text-sm text-slate-900">
                          <span className="font-black">System</span> logged.
                        </p>
...
<<<<<<< HEAD
                          ...
                          <p className="text-sm text-slate-900">
                            <span className="font-black">Operator</span> update.
                          </p>
                          <span className="text-xs text-slate-400 font-mono font-semibold mt-1 block">
